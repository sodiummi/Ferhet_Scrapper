  ...
  return (
    <div className="flex min-h-screen rounded-lg bg-white border border-[#3F54D1]">
      ...
      <aside className="w-64 bg-[#F2F2F2] rounded-2xl py-6 px-4 flex flex-col ml-4 mt-6 mb-8 mr-[-16]">
        ...
        <div className="flex items-center space-x-3 mb-12 ml-[-12]">
      ...
      <main className="flex-1 p-10 mt-[-14]">
        <section className="bg-[#F2F2F2] p-6 rounded-lg">
          <h2 className="text-[#3F54D1] text-3xl font-semibold mb-6">Statistics</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            {[
              ...
              <div key={idx} className="bg-white p-4 rounded text-[#808080]">
                {label}
                <div className="text-4xl font-medium text-black mt-5">{value}</div>
              </div>
            ))}
          </div>
        </section>
